...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_discoveryBP5).setOnClickListener(this);
        findViewById(R.id.btn_discoveryAM3S).setOnClickListener(this);
        findViewById(R.id.btn_stopdiscovery).setOnClickListener(this);
